...
export default function Facilities() {
  ...
  return (
    <section className="py-24 relative overflow-hidden" style={{ background: '#006738' }}>
      <div className="max-w-7xl mx-auto px-6">
        
        <div className="text-center max-w-2xl mx-auto mb-16">
          <FadeInUp>
            <span className="block w-16 h-1 bg-[#EAB308] mx-auto mb-6"></span>
            <h2 className="serif text-4xl font-bold text-white mb-4 relative z-10 inline-block">
              ...
              World-Class <span className="italic text-[#EAB308]">Infrastructure.</span>
            </h2>
