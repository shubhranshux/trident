        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {cards.map((c, i) => (
            <FadeInUp key={c.title} delay={c.delay}>
              <a href={c.href || "#"} {...(c.newTab ? { target: "_blank", rel: "noopener noreferrer" } : {})} className="group block h-[500px] rounded-2xl overflow-hidden relative shadow-[0_15px_30px_-5px_rgba(62,58,54,0.1)] hover:shadow-[0_25px_50px_-15px_rgba(139,110,102,0.3)] transition-all duration-700">
                 {/* Image */}
