      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <FadeInUp delay={700}>
              <a href="https://tat.tekkzy.com/read-our-story/" className="mt-12 group inline-flex items-center gap-3 text-sm font-bold uppercase tracking-widest text-[#3E3A36] hover:text-primary transition-colors">
