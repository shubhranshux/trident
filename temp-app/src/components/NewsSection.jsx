...
export default function NewsSection() {
  return (
    <main className="max-w-7xl mx-auto px-6 py-28 relative bg-[#F5EEEC] z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
        ...
        <div className="lg:col-span-8">
          <FadeInUp>
            ...
            <div className="flex justify-between items-end mb-10">
               <h2 className="serif text-4xl md:text-5xl font-black text-[#3E3A36] relative z-10 inline-block">
                 ...
                 Campus <span className="italic text-[#2C3A8C]">Chronicle.</span>
               </h2>
               <a href="#" className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#3E3A36]/60 hover:text-brand-blue transition-colors hover:translate-x-1 transform duration-300">
          ...
          <FadeInUp delay={200} duration={1000}>
            <div className="mb-12 rounded-[24px] overflow-hidden shadow-[0_20px_50px_-10px_rgba(15,23,42,0.15)] relative group cursor-pointer block border border-transparent hover:border-brand-blue/20 transition-all duration-500">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                ...
                <h3 className="serif text-3xl md:text-4xl font-bold text-white leading-tight drop-shadow-md group-hover:text-[#F5EEEC] transition-colors">Campus Life Flourishes in the Autumn Semester</h3>
              ...
              <FadeInUp key={item.title} delay={100 + (i * 100)}>
                <article className="group cursor-pointer block p-6 rounded-[20px] hover:bg-white hover:shadow-[0_15px_30px_-5px_rgba(15,23,42,0.08)] transition-all duration-500 border border-transparent hover:border-soft h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="serif text-xl font-bold text-[#3E3A36] group-hover:text-brand-blue leading-[1.4] mb-4 transition-colors">{item.title}</h3>
                  </div>
          ...
          <a href="#" className="md:hidden flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-widest text-[#3E3A36]/60 hover:text-brand-blue transition-colors mt-10">
            View Archive <ArrowRight size={14} />
          </a>
        </div>
        ...
        <div className="lg:col-span-4 space-y-10 lg:pt-20">
          ...
          <FadeInUp delay={300}>
            <div className="bg-[#3E3A36] rounded-[24px] p-8 md:p-10 text-white shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="serif text-3xl font-bold mb-8 relative z-10 text-[#F5EEEC]">Student Portals</h3>
              <ul className="space-y-2 relative z-10">
                {["Academic Calendar","Exam Schedule","Fee Payment","Hostel Application","Library Web OPAC"].map(l => (
                  <li key={l}>
                    <a href="#" className="flex items-center justify-between font-semibold text-[14px] text-[#F5EEEC]/80 hover:text-white py-3 border-b border-white/10 group/link transition-all hover:pl-2">
                      <span>{l}</span>
          ...
          <FadeInUp delay={500}>
             <div className="rounded-[24px] overflow-hidden shadow-xl border border-soft group cursor-pointer bg-white relative">
                ...
                <div className="p-8">
                   ...
                   <h3 className="serif text-2xl font-bold text-[#3E3A36] mb-3 group-hover:text-brand-orange transition-colors">Executive Seminars</h3>
                   ...
                   <a href="#" className="text-xs font-bold uppercase tracking-widest text-[#3E3A36] flex items-center gap-2 group-hover:text-brand-orange transition-colors">
